...
export default function OptimalResultPanel({
  ...
  return (
    <div className="floating-overlay right-4 sm:right-6 top-20 w-80 sm:w-96 max-w-[calc(100vw-2rem)] glass-panel p-4 sm:p-5 flex flex-col gap-4 max-h-[calc(100vh-200px)] overflow-y-auto custom-scrollbar transition-all">
      {/* ========================================================================= */}
