    ...
    <header className="h-16 bg-slate-900/90 backdrop-blur-md border-b border-slate-800 px-6 flex items-center justify-between z-30 shrink-0 shadow-lg">
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-2">
          ...
          <h1 className="font-extrabold text-base tracking-tight text-white flex items-center gap-2">
            <span>OmniSite</span>
            <span className="text-[10px] bg-blue-500/20 border border-blue-500/40 text-blue-400 px-2 py-0.5 rounded-full font-mono">B2G SDSS v2.3.0</span>
          </h1>
        </div>
        <div className="h-4 w-px bg-slate-800 mx-2" />
        <div className="flex items-center gap-2 text-xs">
          <span className="text-slate-400">대상 자치구:</span>
          <select
            value={districtId || 1}
      ...
      <div className="flex items-center gap-4 text-xs">
        <div className="flex items-center gap-2 font-mono text-[11px] text-slate-400 bg-slate-950/60 px-3 py-1.5 rounded-lg border border-slate-800">
          ...
          <span>{kstTimeStr || 'KST Live'}</span>
        </div>

        <div className="flex items-center gap-1.5 bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 px-3 py-1.5 rounded-lg font-mono text-[11px]">
          <span>🔒 SHA-256 Hash Chain 100% Verified</span>
        </div>
