...
sources = {
    "dong_mapping": r"c:\Users\Admin\Desktop\빅프로젝트 관련자료\최종1차\데이터\정리데이터\용산구_법정동_행정동_연계매핑.csv",
    "parcels": r"c:\Users\Admin\Desktop\빅프로젝트 관련자료\최종1차\데이터\0706 정제데이터\01.정제데이터\05.용산구_부지면적_좌표(흡연부스 후보).csv",
    "bus_stations": r"c:\Users\Admin\Desktop\빅프로젝트 관련자료\최종1차\데이터\정리데이터\서울시 버스정류소 위치정보_YONGSAN.csv",
    "subway_stations": r"c:\Users\Admin\Desktop\빅프로젝트 관련자료\최종1차\데이터\0706 정제데이터\01.정제데이터\02. 지하철역 위치.csv",
    "bus_passengers": r"c:\Users\Admin\Desktop\빅프로젝트 관련자료\최종1차\데이터\정리데이터\BUS_STATION_BOARDING_MONTH_202605_YONGSAN.csv",
    "subway_passengers": r"c:\Users\Admin\Desktop\빅프로젝트 관련자료\최종1차\데이터\정리데이터\CARD_SUBWAY_MONTH_202605_YONGSAN.csv",
    "illegal_dumping": r"c:\Users\Admin\Desktop\빅프로젝트 관련자료\최종1차\데이터\0706 정제데이터\01.정제데이터\07. 담배꽁초_상습_무단투기.csv",
    "local_population": r"c:\Users\Admin\Desktop\빅프로젝트 관련자료\최종1차\데이터\정리데이터\LOCAL_PEOPLE_DONG_202605_YONGSAN_PEAK.csv",
    "restricted_zones": r"c:\Users\Admin\Desktop\빅프로젝트 관련자료\최종1차\데이터\0706 정제데이터\01.정제데이터\06. 06-07 금연구역 통합본.csv"
}
...
def seed():
    ...
    with engine.connect() as conn:
        ...
        try:
            ...
            # B. Subway Passengers
            subway_pass_headers, subway_pass_rows = load_csv_data(sources["subway_passengers"])
            subway_passenger_totals = defaultdict(list) # Normalized Station Name -> list of (board, alight)
            for row in subway_pass_rows:
            ...
            for row in rest_rows:
                ...
                radius_str = row[5]
                radius = 10.0
                radius_match = re.search(r"(\d+)", radius_str)
                if radius_match:
